...
server.post("/clubs/", function (req, res, next) {
...
function validateClubs(clubs) {
  if (!clubs.id) return "Id is required.";
  if (!clubs.firstName) return "First name is required.";
  if (!clubs.lastName) return "Last name is required.";
  return "";
}
